...
class CacheImpl<T: Any> internal constructor(
    ...
    override fun get(fetcher: Fetcher<T>): Result<T, Exception> = _get(fetcher).first

    override fun getWithSource(fetcher: Fetcher<T>): Pair<Result<T, Exception>, Source> = _get(fetcher)
