...
class KoinActivityB : ScopeActivity() {
    private val TAG = KoinActivityB::class.java.canonicalName

    private val dog : Dog by inject()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val ourSession = getKoin().createScope("ourSessionB", named("DogSession"))
