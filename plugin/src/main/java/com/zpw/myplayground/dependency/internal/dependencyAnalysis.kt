...
import com.zpw.myplayground.dependency.tasks.DependencyReportTask
    ...
    override fun registerAndroidResAnalysisTask(): TaskProvider<AndroidResAnalysisTask> {
        return project.tasks.register<AndroidResAnalysisTask>("findAndroidResUsage$variantNameCapitalized") {
            val resourceArtifacts = project
                .configurations[compileConfigurationName]
                .incoming
                .artifactView {
                    attributes.attribute(attribute, attributeValueRes)
                }.artifacts
//            resourceArtifacts.artifacts.forEach {
//                logger.log("resourceArtifacts is ${it}")
//            }
...
//            manifests.artifacts.forEach {
//                logger.log("manifests is ${it}")
//            }
