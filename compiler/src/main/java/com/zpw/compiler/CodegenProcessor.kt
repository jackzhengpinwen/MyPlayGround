...
abstract class CodegenProcessor<T : Annotation> : AbstractProcessor() {
    ...
    protected open fun onProcessing(processingEnv: ProcessingEnvironment, annotations: MutableSet<out TypeElement>, roundEnv: RoundEnvironment) = Unit
    ...
    private fun <T: Model> generateSources(lang: Language, model: T, originatingElements: Array<TypeElement>): FileObject {
