...
import com.zpw.myplayground.aidl.base.BaseConnectManager;
...
public class HvacManager extends BaseConnectManager<HvacInterface> {
    ...
    private static final String TAG = SdkLogUtils.TAG_FWK + com.fwk.sdk.hvac.HvacManager.class.getSimpleName();

    private static volatile com.fwk.sdk.hvac.HvacManager sHvacManager;
    ...
    public static com.fwk.sdk.hvac.HvacManager getInstance() {
        if (sHvacManager == null) {
            synchronized (com.fwk.sdk.hvac.HvacManager.class) {
                if (sHvacManager == null) {
                    sHvacManager = new com.fwk.sdk.hvac.HvacManager();
                }
            }
        }
        return sHvacManager;
