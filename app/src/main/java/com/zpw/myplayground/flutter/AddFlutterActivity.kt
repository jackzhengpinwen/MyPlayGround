package com.zpw.myplayground.flutter
...
import com.zpw.myplayground.databinding.ActivityFlutterBinding
...
class AddFlutterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = ActivityFlutterBinding.inflate(layoutInflater)
    ...
    private fun initScrollListener(binding: ActivityFlutterBinding) {
    ...
    private fun initAdapter( binding: ActivityFlutterBinding) {
