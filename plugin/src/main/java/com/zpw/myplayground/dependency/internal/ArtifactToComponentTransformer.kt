...
internal class ArtifactToComponentTransformer(
    ...
    private fun computeTransitivity() {
         ...
         */
//        logger.log("directDependencies is ${directDependencies}")
...
//        logger.log("artifact is ${artifact.file.absolutePath}")
        ...
        return zip.entries().toList()
            ...
            .map { classEntry ->
//                logger.log("------- classEntry is ${classEntry}")
                ClassNameCollector().apply {
...
private fun Configuration.directDependencies(): Set<Dependency> {
     ...
     * androidx.appcompat:appcompat:1.4.1
     */
    logger.log("dependencies is ${dependencies}")
